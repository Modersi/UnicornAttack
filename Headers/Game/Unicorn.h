...
constexpr auto RUNNING_ANIMATION_SHEET_PATH =	"Textures/UnicornRunningAnimationSheet.png";
constexpr auto RUNNING_ANIMATION_FRAME_HEIGHT = 92;
constexpr auto RUNNING_ANIMATION_FRAME_WIDTH =	175;

constexpr auto JUMPING_ANIMATION_SHEET_PATH =	"Textures/UnicornJumpingAnimationSheet.png";
constexpr auto JUMPING_ANIMATION_FRAME_HEIGHT = 133;
constexpr auto JUMPING_ANIMATION_FRAME_WIDTH =	162;

constexpr auto FALLING_ANIMATION_SHEET_PATH =	"Textures/UnicornFallingAnimationSheet.png";
constexpr auto FALLING_ANIMATION_FRAME_HEIGHT = 133;
constexpr auto FALLING_ANIMATION_FRAME_WIDTH =	162;

constexpr auto DASHING_ANIMATION_SHEET_PATH =	"Textures/UnicornDashingAnimationSheet.png";
