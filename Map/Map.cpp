...
Map::Map()
{
	...
	tiles.push_back({ 0, GROUND_Y, GROUND_TEXTURE_PATH, GROUND_TEXTURE_WIDTH, GROUND_TEXTURE_HEIGHT });
	tiles.push_back({ GROUND_TEXTURE_WIDTH, GROUND_Y - 100, GROUND_TEXTURE_PATH, GROUND_TEXTURE_WIDTH, GROUND_TEXTURE_HEIGHT });
